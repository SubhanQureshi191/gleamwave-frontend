...
const PriceDisplay = ({ product }) => {
  ...
  const discountPercent =
    product?.discount_percent || product?.discount_percentage || 0;
...
function ProductsContent() {
  ...
  const selectSubCategory = (categoryName, subCategory) => {
    const product = products.find(
      (p) => p.name === subCategory && p.category === categoryName
    );
    if (product) {
  ...
  if (loading) {
    return (
      ...
      >
        <div style={{ fontSize: 24, color: C.maroon }}>
          Loading products...
        </div>
      </div>
    );
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {selectedCategory !== "All"
              ? `Browse our handcrafted ${selectedCategory} collection`
              ...
              <div key={cat.name} style={{ position: "relative" }}>
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 30,
                    border: `2px solid ${
                      selectedCategory === cat.name ? C.maroon : C.goldPale
                    }`,
                    backgroundColor:
                      selectedCategory === cat.name ? C.maroon : "transparent",
                    color:
                ...
                >
                  {cat.name}
                  {cat.subCategories.length > 0 && cat.name !== "All" && (
                    <span
                      onClick={(e) => {
                        e.stopPropagation();
                        toggleCategoryDropdown(cat.name);
                      }}
                      style={{
                        display: "inline-flex",
                        alignItems: "center",
                    ...
                    >
                      <FontAwesomeIcon
                        ...
                        style={{
                          ...
                          transform: expandedCategories[cat.name]
                            ? "rotate(180deg)"
                            : "rotate(0deg)",
                        }}
                      />
                  ...
                  cat.subCategories.length > 0 && (
                    <div
                      style={{
                        ...
                        borderRadius: 12,
                        padding: "8px 0",
                        boxShadow: "0 8px 32px rgba(74,46,34,0.15)",
                        zIndex: 10,
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          >
            {filteredProducts.map((p) => {
              ...
              const discountPercent =
                p.discount_percent || p.discount_percentage || 0;
  ...
  return (
    <Suspense
      fallback={
        ...
        >
          <div style={{ fontSize: 20, color: "#6F4E37" }}>
            Loading products...
          </div>
        </div>
      }
